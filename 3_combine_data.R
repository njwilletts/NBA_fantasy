...
# Merge NBA data with team codes along with which manager owns each player
...
# CHECK: see if any players were unable to be merged with data and fix in config if necessary 
missing_player <- anti_join(fantasy_teams, data2, by = "player_name")
View(missing_player)
...
df_complete <- left_join(data2, schedule2, by = "team_name") 
